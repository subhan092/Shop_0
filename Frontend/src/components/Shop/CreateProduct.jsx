...
const CreateProduct = () => {
 ...
 const {productLoading ,success , error} =   useSelector((state)=>state.products)
 ...
 useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("images", images)
      ...
      console.log("error no create product",error);
